...
class MemberFetcherImplTest {
    ...
    void given_StateObjectEventStream_test_FetchAllByIds() {
        ...
        memberFetcher.handleEventStreamCreatedEvent(new EventStreamCreatedEvent(new EventStream(COLLECTION, TIMESTAMP_PATH, VERSION_OF_PATH, true, null)));
    ...
    void given_VersionObjectEventStream_test_FetchAllByIds() {
        ...
        memberFetcher.handleEventStreamCreatedEvent(new EventStreamCreatedEvent(new EventStream(COLLECTION, TIMESTAMP_PATH, VERSION_OF_PATH, false, null)));
