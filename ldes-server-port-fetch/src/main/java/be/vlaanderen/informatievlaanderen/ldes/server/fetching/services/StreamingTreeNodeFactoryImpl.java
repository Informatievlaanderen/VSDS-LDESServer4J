...
@Component
public class StreamingTreeNodeFactoryImpl {

    private final FragmentRepository fragmentRepository;
    private final AllocationRepository allocationRepository;
    private final MemberFetcher memberFetcher;

    public StreamingTreeNodeFactoryImpl(FragmentRepository fragmentRepository, AllocationRepository allocationRepository, MemberFetcher memberFetcher) {
