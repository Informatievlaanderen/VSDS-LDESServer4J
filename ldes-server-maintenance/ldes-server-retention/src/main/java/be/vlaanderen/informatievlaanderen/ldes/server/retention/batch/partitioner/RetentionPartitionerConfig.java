...
public class RetentionPartitionerConfig {
	...
	@Bean
	public RetentionPolicyPartitioner eventSourceRetentionPolicyPartitioner(RetentionPolicyCollection<EventSourceLevelRetentionPolicy> eventSourceRetentionPolicyCollection) {
