...
public class FragmentCompactionService {
    ...
    public FragmentCompactionService(FragmentRepository fragmentRepository, CompactedFragmentCreator compactedFragmentCreator, ApplicationEventPublisher applicationEventPublisher) {
    ...
    public void compactFragments(Fragment firstFragment, Fragment secondFragment) {
        LdesFragmentIdentifier ldesFragmentIdentifier = generateNewLdesFragmentIdentifier(firstFragment, secondFragment);
