...
public class PaginationCompactionService {
    ...
    public PaginationCompactionService(FragmentRepository fragmentRepository, FragmentCompactionService fragmentCompactionService) {
    ...
    public void applyCompactionStartingFromNode(Fragment fragment) {
        ...
        while (firstFragmentOfCompactionHasOutgoingRelations(firstFragmentOfCompaction)) {
            Optional<Fragment> secondFragmentOfCompaction = retrieveMostCompactedRelationFragment(firstFragmentOfCompaction);
    ...
    private void testAndApplyPossibleCompaction(Fragment firstFragmentOfCompaction, Fragment secondFragmentOfCompaction) {
