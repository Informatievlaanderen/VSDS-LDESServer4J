...
public class CompactionScheduler {
    ...
    private Fragment getRootFragment(ViewCapacity viewCapacity) {
        Observation compactionObservation = Observation.createNotStarted("compaction-retrieve-root", observationRegistry).start();
        Fragment rootFragment = rootFragmentRetriever.retrieveRootFragmentOfView(viewCapacity.getViewName(), compactionObservation);
