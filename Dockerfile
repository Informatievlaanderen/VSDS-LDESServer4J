...
COPY --from=app-stage ldes-fragmentisers/ldes-fragmentisers-geospatial-flat/target/ldes-fragmentisers-geospatial-flat-jar-with-dependencies.jar ./lib/
COPY --from=app-stage ldes-fragmentisers/ldes-fragmentisers-geospatial-hierarchical/target/ldes-fragmentisers-geospatial-hierarchical-jar-with-dependencies.jar ./lib/
