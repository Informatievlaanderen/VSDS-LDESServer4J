...
@ContextConfiguration(classes = { AdminEventStreamsRestController.class, HttpModelConverter.class,
		EventStreamResponseConverterImpl.class, ViewSpecificationConverter.class,
		PrefixAdderImpl.class, ValidatorsConfig.class,
		AdminRestResponseEntityExceptionHandler.class, RetentionModelExtractor.class,
		FragmentationConfigExtractor.class, AdminWebConfig.class, RequestContextExtracter.class })
