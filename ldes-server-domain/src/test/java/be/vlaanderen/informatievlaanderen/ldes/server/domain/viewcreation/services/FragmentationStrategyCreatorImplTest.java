// package
// be.vlaanderen.informatievlaanderen.ldes.server.domain.viewcreation.services;
//
// import
...
// import
// be.vlaanderen.informatievlaanderen.ldes.server.domain.ldesfragment.services.FragmentationStrategyImpl;
// import
// be.vlaanderen.informatievlaanderen.ldes.server.domain.ldesfragment.services.RootFragmentCreator;
// import
// be.vlaanderen.informatievlaanderen.ldes.server.domain.tree.member.repository.MemberRepository;
// import
// be.vlaanderen.informatievlaanderen.ldes.server.domain.viewcreation.valueobjects.ConfigProperties;
// import
// be.vlaanderen.informatievlaanderen.ldes.server.domain.viewcreation.valueobjects.FragmentationConfig;
// import
// be.vlaanderen.informatievlaanderen.ldes.server.domain.viewcreation.valueobjects.ViewSpecification;
...
// private static final Map<String, String> TIMEBASED_PROPERTIES =
// Map.of("timebasedProperty", "time");
// private static final Map<String, String> GEOSPATIAL_PROPERTIES =
// Map.of("geospatialProperty", "geo");
...
// mock(RootFragmentCreator.class);
...
// @Test
// void
// when_ViewSpecificationFragmentationConfigIsNull_FragmentationStrategyImplIsReturned()
// {
...
// @Test
// void
// when_ViewSpecificationFragmentationConfigIsNotNull_WrappedFragmentationStrategyIsReturned()
// {
// FragmentationStrategyWrapper timebasedFragmentationStrategyWrapper =
...
// FragmentationStrategy timebasedFragmentationStrategy =
...
// any(),
// eq(new
// ConfigProperties(TIMEBASED_PROPERTIES)))).thenReturn(timebasedFragmentationStrategy);
//
// FragmentationStrategyWrapper geospatialFragmentationStrategyWrapper =
// mock(FragmentationStrategyWrapper.class);
// when(applicationContext.getBean(GEOSPATIAL)).thenReturn(geospatialFragmentationStrategyWrapper);
// FragmentationStrategy geospatialFragmentationStrategy =
// mock(FragmentationStrategy.class);
...
// }
//
// private FragmentationConfig getFragmentationConfig(String name, Map<String,
// String> config) {
