...
//
// import
// be.vlaanderen.informatievlaanderen.ldes.server.domain.ldesfragment.NonCriticalTasksExecutor;
// import
...
// mock(NonCriticalTasksExecutor.class);
//
// private final FragmentationStrategyImpl fragmentationStrategy = new
// FragmentationStrategyImpl(
// ldesFragmentRepository,
// memberRepository, nonCriticalTasksExecutor);
//
// @Test
// void
// when_memberIsAddedToFragment_FragmentationStrategyImplSavesUpdatedFragment()
// {
// LdesFragment ldesFragment = new LdesFragment(new FragmentInfo("view",
// List.of()));
...
// // verify(memberRepository, times(1)).saveMemberReference("memberId",
// "/view");
