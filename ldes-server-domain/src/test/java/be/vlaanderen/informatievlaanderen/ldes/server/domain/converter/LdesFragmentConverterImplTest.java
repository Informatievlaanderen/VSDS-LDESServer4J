...
class LdesFragmentConverterImplTest {
    ...
    void when_LdesFragmentIsDummy_ModelHasFourStatements() {
        LdesFragment ldesFragment = new LdesFragment(FRAGMENT_ID, new FragmentInfo(String.format("%s/%s", HOSTNAME, COLLECTION_NAME), SHAPE, COLLECTION_NAME, TIMESTAMP_PATH, null));
    ...
    void when_LdesFragmentExists_ModelHasGeneralStatementsAndViewStatementAndRelationStatementsAndMemberStatements() {
        ...
        when(ldesMemberRepository.getLdesMemberById("https://private-api.gipod.beta-vlaanderen.be/api/v1/mobility-hindrances/10228622/165")).thenReturn(ldesMember);
