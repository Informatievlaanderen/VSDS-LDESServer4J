...
//
// import
// be.vlaanderen.informatievlaanderen.ldes.server.domain.ldes.retentionpolicy.RetentionPolicy;
// import
// be.vlaanderen.informatievlaanderen.ldes.server.domain.ldes.retentionpolicy.timebased.TimeBasedRetentionPolicy;
// import
...
// import
// be.vlaanderen.informatievlaanderen.ldes.server.domain.tree.member.services.TreeMemberRemover;
// import
// be.vlaanderen.informatievlaanderen.ldes.server.domain.tree.memberreferences.entities.MemberReferencesRepository;
...
// private final MemberReferencesRepository referencesRepository =
// mock(MemberReferencesRepository.class);
// private final TreeMemberRemover treeMemberRemover =
// mock(TreeMemberRemover.class);
// private final ParentUpdater parentUpdater = mock(ParentUpdater.class);
// private final TreeNodeRemover treeNodeRemover = new
// TreeNodeRemoverImpl(fragmentRepository, retentionPolicyMap,
// referencesRepository, treeMemberRemover, parentUpdater);
//
// @Test
// void
// when_NodeIsImmutableAndSatisfiesRetentionPoliciesOfView_NodeCanBeSoftDeleted()
// {
...
// verify(referencesRepository, times(1)).removeMemberReference("memberId",
// "/view");
