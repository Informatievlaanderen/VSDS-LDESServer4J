...
class ViewSpecificationConverterTest {
	...
	void setup() throws URISyntaxException {
		...
		view = new ViewSpecification(viewName, List.of(retentionModel), fragmentations, pageSize);
	...
	private ViewSpecification getExpectedViewSpecification() {
		...
		return new ViewSpecification(new ViewName(COLLECTION_NAME, VIEW_NAME), List.of(), fragmentations, pageSize);
	}
