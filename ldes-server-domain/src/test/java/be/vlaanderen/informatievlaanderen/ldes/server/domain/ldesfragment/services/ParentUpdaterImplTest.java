...
// private static final LdesFragment PARENT = new LdesFragment(new
// FragmentInfo(VIEW, List.of()));
//
// @BeforeEach
// void setUp() {
...
// @Test
// void
// when_ParentIsPointingToDeletedChild_RelationIsRemovedAndNewRelationToNonDeletedChildIsAdded()
// {
...
// assertEquals(NON_DELETED_CHILD.getFragmentId(),
// PARENT.getRelations().get(0).treeNode());
// }
//
// @Test
...
//
// MissingFragmentException missingFragmentException =
// assertThrows(MissingFragmentException.class,
// () -> parentUpdater.updateParent(DELETED_CHILD));
...
// @Test
// void
// when_ParentIsNotPointingToDeletedChild_ParentRemainsAsIsAndNoNeedToSave() {
...
// assertEquals(NON_DELETED_CHILD.getFragmentId(),
// PARENT.getRelations().get(0).treeNode());
// verify(ldesFragmentRepository, times(1)).retrieveMutableFragment(VIEW,
// List.of());
