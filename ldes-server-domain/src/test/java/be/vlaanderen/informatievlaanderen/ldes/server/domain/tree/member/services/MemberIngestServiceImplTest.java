// package
// be.vlaanderen.informatievlaanderen.ldes.server.domain.tree.member.services;
//
// import
...
// mock(FragmentationMediator.class);
...
//
// @Test
// @DisplayName("Adding Member when there is a member with the same id that
// already exists")
...
//
// @Test
// @DisplayName("Adding Member when there is no existing member with the same
// id")
// void when_TheMemberDoesNotAlreadyExists_thenMemberIsStored() throws
// IOException {
// String ldesMemberString =
// FileUtils.readFileToString(ResourceUtils.getFile("classpath:example-ldes-member.nq"),
// StandardCharsets.UTF_8);
...
// inOrder.verify(fragmentationMediator,
// times(1)).addMemberToFragment(savedMember);
// inOrder.verifyNoMoreInteractions();
// }
// }