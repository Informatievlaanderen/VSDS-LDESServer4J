...
public class ParentUpdaterImpl implements ParentUpdater {
    ...
    public ParentUpdaterImpl(LdesFragmentRepository ldesFragmentRepository, TreeRelationsRepository treeRelationsRepository) {
    ...
    public void updateParent(LdesFragment currentChild) {
        ...
        Optional<TreeRelation> optionalOldTreeRelation =
                relations.stream()
                        .filter(treeRelation ->
                                treeRelation.treeNode().equals(childId)).findFirst();
