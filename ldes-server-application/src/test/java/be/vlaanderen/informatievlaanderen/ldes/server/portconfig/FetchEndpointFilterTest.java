...
class FetchEndpointFilterTest {
    private final String FETCH_PORT = "8081";
    private final String OTHER_PORT = "8082";
    private FetchEndpointFilter filter;
    ...
    void setup() throws IOException {
        filter = new FetchEndpointFilter(FETCH_PORT);
    ...
    void when_RequestFromCorrectPort_Then_ContinueFilterChain() throws ServletException, IOException {
        when(request.getLocalPort()).thenReturn(Integer.parseInt(FETCH_PORT));
    ...
    @Test
    void when_RequestIsNotGET_Then_ContinueFilterChain() throws ServletException, IOException {
        when(request.getLocalPort()).thenReturn(Integer.parseInt(OTHER_PORT));
