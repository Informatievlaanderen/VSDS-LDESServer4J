...
public class PaginationPage {
	...
	public PaginationPage(long id, String viewNameUrlPrefix, Bucket bucket, PageNumber pageNumber, int availableMemberSpace) {
		this.id = id;
	...
	public static PaginationPage createWithPartialUrl(long id, long bucketId, String partialUrl, int availableMemberSpace) {
		...
		return new PaginationPage(id, urlPrefix, new Bucket(bucketId, descriptorParts[0]), pageNumber, availableMemberSpace);
	}
