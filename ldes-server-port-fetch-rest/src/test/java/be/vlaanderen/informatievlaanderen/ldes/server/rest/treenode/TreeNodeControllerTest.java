...
// import
// be.vlaanderen.informatievlaanderen.ldes.server.domain.exceptions.DeletedFragmentException;
// import
// be.vlaanderen.informatievlaanderen.ldes.server.domain.exceptions.MissingFragmentException;
// import
// be.vlaanderen.informatievlaanderen.ldes.server.domain.ldesfragment.entities.LdesFragment;
// import
// be.vlaanderen.informatievlaanderen.ldes.server.domain.ldesfragment.services.FragmentFetchService;
// import
...
// import
// be.vlaanderen.informatievlaanderen.ldes.server.domain.tree.node.services.TreeNodeConverter;
// import
// be.vlaanderen.informatievlaanderen.ldes.server.domain.tree.node.services.TreeNodeConverterImpl;
// import
// be.vlaanderen.informatievlaanderen.ldes.server.domain.tree.node.services.TreeNodeFetcher;
// import
// be.vlaanderen.informatievlaanderen.ldes.server.rest.exceptionhandling.RestResponseEntityExceptionHandler;
// import
// be.vlaanderen.informatievlaanderen.ldes.server.rest.treenode.config.TreeViewWebConfig;
...
//
// import static
// be.vlaanderen.informatievlaanderen.ldes.server.domain.constants.RdfConstants.GENERATED_AT_TIME;
// import static
// be.vlaanderen.informatievlaanderen.ldes.server.domain.constants.RdfConstants.TREE_NODE_RESOURCE;
...
//
// @ParameterizedTest(name = "Correct getting of an open LdesFragment from the
// REST Service with mediatype{0}")
// @ArgumentsSource(MediaTypeRdfFormatsArgumentsProvider.class)
// void when_GETRequestIsPerformed_ResponseContainsAnLDesFragment(String
// mediaType, Lang lang, boolean immutable,
...
// Model resultModel =
// RDFParserBuilder.create().fromString(result.getResponse().getContentAsString()).lang(lang)
// .toModel();
...
// void
// when_GETRequestIsPerformedWithUnsupportedMediaType_ResponseIs406HttpMediaTypeNotAcceptableException()
// throws Exception {
...
// mockMvc.perform(get("/view").accept("application/n-quads")).andDo(print())
...
// assertEquals("Fragment with following identifier has been deleted:
// fragmentId",
// resultActions.andReturn().getResponse().getContentAsString());
// }
//
...
// void when_GETRequestIsPerformedOnOtherCollectionName_ResponseIs404() throws
// Exception {
// mockMvc.perform(get("/")
// .param("generatedAtTime",
// FRAGMENTATION_VALUE_1)
...
// {
// return Stream.of(
// Arguments.of("application/n-quads", Lang.NQUADS, true, "public,
// max-age=604800, immutable"),
// Arguments.of("application/ld+json", Lang.JSONLD11, true, "public,
// max-age=604800, immutable"),
