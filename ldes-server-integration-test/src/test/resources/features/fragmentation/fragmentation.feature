Feature: LDES Server Fragmentation
  ...
  Scenario Outline: Server Can Fragment an LDES using nested Reference Fragmentation strategies
    ...
    Then this fragment only has 1 "Relation" relation
    When I fetch the next fragment through the first "Relation"
    Then this fragment only has <expectedRelationCount1> "EqualToRelation" relation
    And this fragment is mutable
    When I fetch the <firstPath> fragment
    Then this fragment only has 1 "Relation" relation
    When I fetch the next fragment through the first "Relation"
    And this fragment contains <expectedMemberCount1> members
    ...
    Then this fragment only has 1 "Relation" relation
    When I fetch the next fragment through the first "Relation"
    And this fragment contains <expectedMemberCount2> members
    Examples:
      | eventStreamDescriptionFile                                                    | firstTemplate                                      | secondTemplate                                     | collection            | expectedMemberCount | expectedRelationCount1 | rootEqualToRelationCount | firstFragmentValue                                                                              | firstPath                                                                                                                                                                                                                                    | expectedMemberCount1 | secondFragmentValue                                                                             | secondPath                                                                                                                                                                                                                                   | expectedMemberCount2 |
