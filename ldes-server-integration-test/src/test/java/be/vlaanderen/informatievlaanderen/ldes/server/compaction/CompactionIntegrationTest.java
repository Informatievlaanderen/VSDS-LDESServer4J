...
//        CompactionCandidateService.class, CompactionIntegrationTest.CompactionIntegrationTestConfiguration.class, ViewCapacityCreator.class, PageRelationPostgresRepository.class})
//@ComponentScan(value = {"be.vlaanderen.informatievlaanderen.ldes.server.compaction", "be.vlaanderen.informatievlaanderen.ldes.server.pagination," +
//        "be.vlaanderen.informatievlaanderen.ldes.server.pagination.postgres"},
