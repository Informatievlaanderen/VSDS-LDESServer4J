...
// tileFragmentRelationsAttributer = new
// TileFragmentRelationsAttributer(treeNodeRelationsRepository);
// }
//
// @Test
// void
// when_TileFragmentsAreCreated_RelationsBetweenRootAndCreatedFragmentsAreAdded()
// {
...
//
// Stream<LdesFragment> ldesFragments =
// tileFragmentRelationsAttributer.addRelationsFromRootToBottom(
// rootFragment.ldesFragment(), List.of(tileFragmentOne, tileFragmentTwo,
// tileFragmentThree));
//
// assertEquals(2, rootFragment.ldesFragment().getRelations().size());
// assertEquals(List.of(tileFragmentOne.ldesFragment(),
// tileFragmentTwo.ldesFragment(),
// tileFragmentThree.ldesFragment()),
// ldesFragments.collect(Collectors.toList()));
// verify(ldesFragmentRepository,
// times(1)).saveFragment(rootFragment.ldesFragment());
// }
//
// private TileFragment createTileFragment(String tile, boolean created) {
// return new TileFragment(PARENT_FRAGMENT.createChild(new FragmentPair("tile",
// tile)),
// created);
// }
//
