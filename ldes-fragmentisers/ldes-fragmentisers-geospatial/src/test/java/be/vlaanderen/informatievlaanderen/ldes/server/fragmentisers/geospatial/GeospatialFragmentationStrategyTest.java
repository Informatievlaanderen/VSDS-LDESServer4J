// package
// be.vlaanderen.informatievlaanderen.ldes.server.fragmentisers.geospatial;
//
// import
...
// import
// be.vlaanderen.informatievlaanderen.ldes.server.fragmentisers.geospatial.bucketising.GeospatialBucketiser;
// import
// be.vlaanderen.informatievlaanderen.ldes.server.fragmentisers.geospatial.connected.relations.TileFragmentRelationsAttributer;
// import
// be.vlaanderen.informatievlaanderen.ldes.server.fragmentisers.geospatial.fragments.GeospatialFragmentCreator;
// import
...
// ldesFragmentRepository, geospatialBucketiser, fragmentCreator,
// tileFragmentRelationsAttributer, tracer,
// treeNodeRelationsRepository);
// }
//
// @Test
// void
// when_TileFragmentsAreCreated_RelationsAreAttributedAndDecoratedServiceIsCalled()
// {
...
// TileFragment tileFragmentTwo = mockCreationGeospatialFragment("2/2/2",
// false);
// TileFragment tileFragmentThree = mockCreationGeospatialFragment("3/3/3",
// true);
// TileFragment rootTileFragment = mockCreationGeospatialFragment("0/0/0",
// false);
// when(tileFragmentRelationsAttributer.addRelationsFromRootToBottom(eq(rootTileFragment.ldesFragment()),
// anyList()))
// .thenReturn(Stream.of(tileFragmentOne.ldesFragment(),
// tileFragmentTwo.ldesFragment(),
...
// times(1)).addMemberToFragment(tileFragmentOne.ldesFragment(),
// member, childSpan);
// verify(decoratedFragmentationStrategy,
// times(1)).addMemberToFragment(tileFragmentTwo.ldesFragment(),
// member, childSpan);
// verify(decoratedFragmentationStrategy,
// times(1)).addMemberToFragment(tileFragmentThree.ldesFragment(),
// member, childSpan);
...
// when(geospatialBucketiser.bucketise(member)).thenReturn(Set.of("1/1/1",
// "2/2/2", "3/3/3"));
// TileFragment tileFragmentOne = mockCreationGeospatialFragment("1/1/1",
// false);
// TileFragment tileFragmentTwo = mockCreationGeospatialFragment("2/2/2",
// false);
// TileFragment tileFragmentThree = mockCreationGeospatialFragment("3/3/3",
...
// }
//
// private TileFragment mockCreationGeospatialFragment(String tile, boolean
// created) {
// TileFragment tileFragment = new TileFragment(PARENT_FRAGMENT.createChild(new
// FragmentPair("tile", tile)),
// created);
// when(fragmentCreator.getOrCreateGeospatialFragment(PARENT_FRAGMENT, tile,
// rootTileFragment))
