...
class GeospatialRelationsAttributerTest {
	...
	void when_FragmentsAreNeighbours_GeospatialRelationsAreAdded() {
		...
		ldesFragment.addRelation(new TreeRelation(GEOSPARQL_AS_WKT, "15/4/3",
				"<http://www.opengis.net/def/crs/OGC/1.3/CRS84> POLYGON ((-179.945068359375 85.04828470083632, -179.945068359375 85.04733631224822, -179.9560546875 85.04733631224822, -179.9560546875 85.04828470083632, -179.945068359375 85.04828470083632))",
				WKT_DATA_TYPE, TREE_GEOSPATIALLY_CONTAINS_RELATION));
