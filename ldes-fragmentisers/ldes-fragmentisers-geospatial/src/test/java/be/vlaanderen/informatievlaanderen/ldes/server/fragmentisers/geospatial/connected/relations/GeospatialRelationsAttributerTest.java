...
class GeospatialRelationsAttributerTest {
	...
	private static final TreeRelation EXPECTED_RELATION = new TreeRelation("http://www.opengis.net/ont/geosparql#asWKT",
			...
			"http://www.opengis.net/ont/geosparql#wktLiteral", "https://w3id.org/tree#GeospatiallyContainsRelation");
	...
	void setUp() {
		...
		CHILD_FRAGMENT = new LdesFragment(
				new FragmentInfo(VIEW_NAME, List.of(new FragmentPair(FRAGMENT_KEY_TILE, "1/1/1"))));
	}

	@Test
	void when_ParentHasNotYetRelation_AddRelation() {
		geospatialRelationsAttributer.addRelationToParentFragment(PARENT_FRAGMENT, CHILD_FRAGMENT);
