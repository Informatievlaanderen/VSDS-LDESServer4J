...
class AdjacentLdesFragmentFilterTest {
    ...
    LdesFragment ldesFragment = new LdesFragment("", new FragmentInfo("", "", "", List.of(new FragmentPair(FRAGMENT_KEY_TILE, "15/4/4"))));
    ...
    static class LdesFragmentArgumentsSource implements ArgumentsProvider {
        ...
        private LdesFragment getLdesFragment(String fragmentValue) {
            return new LdesFragment("", new FragmentInfo("", "", "", List.of(new FragmentPair(FRAGMENT_KEY_TILE, fragmentValue))));
        }
    }
