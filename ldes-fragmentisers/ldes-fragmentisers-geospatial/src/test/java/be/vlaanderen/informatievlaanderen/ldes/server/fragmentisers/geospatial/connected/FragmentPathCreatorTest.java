...
import be.vlaanderen.informatievlaanderen.ldes.server.fragmentisers.geospatial.GeospatialFragmentNamingStrategy;
...
class FragmentPathCreatorTest {
    ...
    void when_StartAndEndFragmentsAreGiven_InBetweenFragmentsAreGenerated() {
        ...
        LdesFragment firstFragment = fragmentCreator.createNewFragment(Optional.empty(), new FragmentPair(GeospatialConstants.FRAGMENT_KEY_TILE, "15/0/0"));
        LdesFragment secondFragment = fragmentCreator.createNewFragment(Optional.empty(), new FragmentPair(GeospatialConstants.FRAGMENT_KEY_TILE, "15/3/5"));

        Set<LdesFragment> ldesFragments = fragmentPathCreator.createFragmentPath(firstFragment, secondFragment);
