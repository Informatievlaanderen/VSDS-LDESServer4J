...
public class TileBucketRelationsAttributer implements RelationsAttributer {
	...
	public void addRelationsFromRootToBottom(Bucket rootBucket, Bucket tileBucket) {
		...
		BucketRelation bucketRelation = isDefaultBucket ? BucketRelation.generic() : createGeospatialRelationToParent(tileBucket);
		rootBucket.addChildBucket(tileBucket.withRelation(bucketRelation));
	}

	private BucketRelation createGeospatialRelationToParent(Bucket childBucket) {
