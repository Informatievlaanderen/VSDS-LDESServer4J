...
public class FragmentPathCreator {
    ...
    public Set<LdesFragment> createFragmentPath(LdesFragment firstFragment, LdesFragment secondFragment) {
        ...
        return bucketsInBetween.stream()
                .map(bucket -> fragmentCreator.createNewFragment(Optional.empty(), new FragmentPair(FRAGMENT_KEY_TILE, bucket)))
                .collect(Collectors.toSet());
    }

    private Set<String> getBucketsInBetween(LdesFragment firstFragment, LdesFragment secondFragment, Tile firstTile, Tile secondTile) {
