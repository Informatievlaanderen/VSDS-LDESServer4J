...
//
// import
// be.vlaanderen.informatievlaanderen.ldes.server.domain.events.ingest.MemberIngestedEvent;
// import
...
// private static final ViewName VIEW_NAME = new ViewName(COLLECTION_NAME,
// "view");
...
//
// fragmentationExecutor.executeFragmentation(new
// MemberIngestedEvent(member.getModel(), member.getLdesMemberId(),
...
// final ViewName alternativeViewName = new ViewName("otherCollection",
// "otherView");
// Fragment fragment = new Fragment(new
// LdesFragmentIdentifier(alternativeViewName, List.of()));
...
// when(member.getCollectionName()).thenReturn(COLLECTION_NAME);
//
// MemberIngestedEvent memberIngestedEvent = new
// MemberIngestedEvent(member.getModel(), member.getLdesMemberId(),
// member.getCollectionName(), member.getSequenceNr());
//
