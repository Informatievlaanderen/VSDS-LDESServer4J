package be.vlaanderen.informatievlaanderen.ldes.server.fragmentisers.geospatial.hierarchy.constants;
...
public class GeospatialConstants {
	...
	public static final String FRAGMENT_KEY_TILE_ROOT = "root";
