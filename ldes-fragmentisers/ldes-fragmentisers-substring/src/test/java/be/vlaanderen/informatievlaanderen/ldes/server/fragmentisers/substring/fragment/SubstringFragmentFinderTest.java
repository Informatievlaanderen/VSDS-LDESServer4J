...
// import
// be.vlaanderen.informatievlaanderen.ldes.server.fragmentisers.substring.config.SubstringConfig;
// import
// be.vlaanderen.informatievlaanderen.ldes.server.fragmentisers.substring.relations.SubstringRelationsAttributer;
...
// substringFragmentFinder = new
// SubstringFragmentFinder(substringFragmentCreator, substringConfig,
...
//
// LdesFragment actualFragment =
// substringFragmentFinder.getOpenLdesFragmentOrLastPossibleFragment(PARENT_FRAGMENT,
...
// LdesFragment aFragment = PARENT_FRAGMENT.createChild(new
// FragmentPair(SUBSTRING, "a"));
// aFragment.addMember("anotherMember");
// LdesFragment abFragment = PARENT_FRAGMENT.createChild(new
