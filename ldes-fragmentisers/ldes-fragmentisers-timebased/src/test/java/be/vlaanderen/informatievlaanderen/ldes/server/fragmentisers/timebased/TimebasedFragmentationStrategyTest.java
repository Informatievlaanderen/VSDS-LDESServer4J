...
//
// import static
// be.vlaanderen.informatievlaanderen.ldes.server.domain.constants.RdfConstants.GENERIC_TREE_RELATION;
...
// new FragmentInfo(VIEW_NAME, List.of(new FragmentPair("generatedAtTime",
// "someTime"))));
...
// void
// when_MemberisNotYetAddedAndNoParentRelation_thenFragmentationIsAppliedAndRelationCreated()
// {
...
// member, parentSpan);
//
// InOrder inOrder = inOrder(ldesFragmentRepository, openFragmentProvider,
...
// void
// when_MemberisNotYetAddedButAlreadyParentRelation_thenFragmentationIsApplied()
// {
// Member member = mock(Member.class);
// when(member.getLdesMemberId()).thenReturn("memberId");
// PARENT_FRAGMENT.addRelation(new TreeRelation("",
// OPEN_FRAGMENT.getFragmentId(), "", "",
