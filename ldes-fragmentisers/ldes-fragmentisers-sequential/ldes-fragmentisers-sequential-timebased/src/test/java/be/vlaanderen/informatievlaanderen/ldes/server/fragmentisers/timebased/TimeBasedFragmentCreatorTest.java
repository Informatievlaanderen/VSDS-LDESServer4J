...
// import
// be.vlaanderen.informatievlaanderen.ldes.server.domain.config.LdesFragmentNamingStrategy;
// import
...
// import
// be.vlaanderen.informatievlaanderen.ldes.server.fragmentisers.timebased.config.TimeBasedFragmentNamingStrategy;
...
//
// import static
// be.vlaanderen.informatievlaanderen.ldes.server.domain.constants.RdfConstants.TREE_MEMBER;
// import static
// be.vlaanderen.informatievlaanderen.ldes.server.fragmentisers.timebased.TimeBasedFragmentCreator.DATE_TIME_TYPE;
...
// @BeforeEach
// void setUp() {
// SequentialFragmentationConfig timeBasedConfig =
// createSequentialFragmentationConfig();
// LdesFragmentNamingStrategy timeBasedFragmentNamingStrategy = new
// TimeBasedFragmentNamingStrategy();
...
// fragmentCreator.createNewFragment(Optional.empty(), null);
//
...
//
// LdesFragment newFragment =
// fragmentCreator.createNewFragment(Optional.of(existingLdesFragment), null);
//
// verifyAssertionsOnAttributesOfFragment(newFragment);
// assertEquals(0, newFragment.getCurrentNumberOfMembers());
// verifyRelationOfFragment(newFragment, "Path", "someId", "Value",
...
// return new
// LdesMember("https://private-api.gipod.beta-vlaanderen.be/api/v1/mobility-hindrances/10228622/483",
// ldesMemberModel);
// }
//
