...
public class TimebasedFragmentationUpdater implements FragmentationUpdater {
    ...
    public FragmentationService updateFragmentationService(ApplicationContext applicationContext, FragmentationService fragmentationService) {
        ...
        SequentialFragmentationConfig sequentialFragmentationConfig = applicationContext.getBean(SequentialFragmentationConfig.class);


        TimeBasedFragmentCreator timeBasedFragmentCreator = new TimeBasedFragmentCreator(ldesConfig1, sequentialFragmentationConfig,
                ldesMemberRepository1, ldesFragmentRepository1);
        return new SequentialFragmentationService(fragmentationService, ldesConfig1, timeBasedFragmentCreator, ldesMemberRepository1,
