...
// @BeforeEach
// void setUp() {
// fragmentCreator = new GeospatialFragmentCreator(ldesConfig, new
// GeospatialFragmentNamingStrategy());
// fragmentPathCreator = new FragmentPathCreator(geospatialConfig,
// fragmentCreator);
// }
//
// @Test
...
// LdesFragment firstFragment =
// fragmentCreator.createNewFragment(Optional.empty(),
// new FragmentPair(GeospatialConstants.FRAGMENT_KEY_TILE, "15/0/0"));
// LdesFragment secondFragment =
// fragmentCreator.createNewFragment(Optional.empty(),
// new FragmentPair(GeospatialConstants.FRAGMENT_KEY_TILE, "15/3/5"));
//
// Set<LdesFragment> ldesFragments =
// fragmentPathCreator.createFragmentPath(firstFragment, secondFragment,
// fragmentPairList);
...
// return Stream.of("15/0/1", "15/0/2", "15/0/3", "15/0/4", "15/0/5", "15/1/5",
// "15/2/5")
