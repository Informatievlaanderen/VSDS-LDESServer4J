...
// private final static List<String> FRAGMENTS_BETWEEN_SOURCE_AND_CLOSEST =
// List.of("15/4/3", "15/3/3", "15/2/3");
// private final static List<String> OTHER_FRAGMENT_IDS = List.of("15/15/4",
// "15/4/10", "15/7/7");
// private final FragmentPathCreator fragmentPathCreator =
// mock(FragmentPathCreator.class);
// private final ClosestFragmentDiscoverer closestFragmentDiscoverer = new
// ClosestFragmentDiscoverer();
// private final FragmentGenerator fragmentGenerator = new
// FragmentGenerator(closestFragmentDiscoverer,
// fragmentPathCreator);
//
// @Test
// @DisplayName("Verify generation of fragments between original fragment and
// closest fragment")
// void
// when_FragmentAndCollectionOfAvailable_FragmentsOnPathToClosestFragmentAreReturned()
// {
...
// getAvailableFragments(closestFragment);
// when(fragmentPathCreator.createFragmentPath(ldesFragment, closestFragment,
// fragmentPairList))
// .thenReturn(getFragmentsInBetween());
//
// List<LdesFragment> fragmentsInPath =
// fragmentGenerator.generateFragmentPathToClosestFragment(ldesFragment,
...
// assertEquals(expectedFragmentIdsInPath,
// getActualFragmentIdsInPath(fragmentsInPath));
// }
//
// private Set<String> getActualFragmentIdsInPath(List<LdesFragment>
// fragmentsInPath) {
...
// return Stream.of(List.of(FRAGMENT_ID, CLOSEST_FRAGMENT_ID),
// FRAGMENTS_BETWEEN_SOURCE_AND_CLOSEST)
// .flatMap(List::stream)
// .collect(Collectors.toSet());
// }
//
...
// }
//
// private List<LdesFragment> getAvailableFragments(LdesFragment
// closestFragment) {
