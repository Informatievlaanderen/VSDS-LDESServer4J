...
// import
// be.vlaanderen.informatievlaanderen.ldes.server.domain.tree.member.services.MemberIngestService;
// import
// be.vlaanderen.informatievlaanderen.ldes.server.ingestion.rest.config.IngestionWebConfig;
...
//
// @ParameterizedTest(name = "Ingest an LDES member in the REST service using
// ContentType {0}")
// @ArgumentsSource(ContentTypeRdfFormatLangArgumentsProvider.class)
// void when_POSTRequestIsPerformed_LDesMemberIsSaved(String contentType, Lang
// rdfFormat) throws Exception {
// String ldesMemberString =
// readLdesMemberDataFromFile("example-ldes-member.nq", rdfFormat);
//
...
// throws Exception {
// String ldesMemberString =
// readLdesMemberDataFromFile("example-ldes-member.nq", Lang.NQUADS);
//
