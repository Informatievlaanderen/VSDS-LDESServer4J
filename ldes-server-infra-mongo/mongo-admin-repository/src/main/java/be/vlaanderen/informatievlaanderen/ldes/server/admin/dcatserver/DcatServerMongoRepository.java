package be.vlaanderen.informatievlaanderen.ldes.server.admin.dcatserver;

import be.vlaanderen.informatievlaanderen.ldes.server.admin.dcatserver.repository.DcatCatalogEntityRepository;
import be.vlaanderen.informatievlaanderen.ldes.server.admin.dcatserver.service.DcatCatalogEntityConverter;
