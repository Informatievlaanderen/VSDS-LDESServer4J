...
@ChangeUnit(id = "eventstream-updater-changeset-16", order = "2024-05-06 00:00:10", author = "VSDS")
public class RetentionMemberUpdaterChange {
    public static final String MEMBER_COLLECTION_NAME = "retention_member_properties";

    private static final Logger log = LoggerFactory.getLogger(RetentionMemberUpdaterChange.class);
