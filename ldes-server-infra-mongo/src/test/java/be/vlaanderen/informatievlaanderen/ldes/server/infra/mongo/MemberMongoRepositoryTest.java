...
// import
// be.vlaanderen.informatievlaanderen.ldes.server.infra.mongo.entities.LdesMemberEntity;
// import
// be.vlaanderen.informatievlaanderen.ldes.server.infra.mongo.repositories.LdesMemberEntityRepository;
...
// mock(LdesMemberEntityRepository.class);
// private final MemberMongoRepository ldesMemberMongoRepository = new
...
// RdfModelConverter.fromString(member, Lang.NQUADS),
// treeNodeReferences);
// LdesMemberEntity ldesMemberEntity =
// LdesMemberEntity.fromLdesMember(treeMember);
