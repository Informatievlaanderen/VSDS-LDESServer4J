...
// ldesFragmentEntity.getFragmentInfo().getViewName()
// .equals(VIEW_NAME))
// .collect(Collectors.toList()));
//
// Optional<LdesFragment> ldesFragment =
// ldesFragmentMongoRepository.retrieveMutableFragment(
// VIEW_NAME,
// List.of());
//
...
// String viewName,
// String value) {
// FragmentInfo fragmentInfo = new FragmentInfo(viewName, List.of(new
// FragmentPair("generatedAtTime", value)),
