...
// import
// be.vlaanderen.informatievlaanderen.ldes.server.infra.mongo.entities.LdesFragmentEntity;
// import
// be.vlaanderen.informatievlaanderen.ldes.server.infra.mongo.repositories.LdesFragmentEntityRepository;
...
//
// import static
// be.vlaanderen.informatievlaanderen.ldes.server.infra.mongo.LdesFragmentMongoRepositoryTest.LdesFragmentEntityListProvider.allMutable;
...
//
// private final LdesFragmentEntityRepository ldesFragmentEntityRepository =
// mock(LdesFragmentEntityRepository.class);
//
// private final LdesFragmentMongoRepository ldesFragmentMongoRepository = new
// LdesFragmentMongoRepository(
// ldesFragmentEntityRepository);
//
// @ParameterizedTest
// @ArgumentsSource(LdesFragmentEntityListProvider.class)
// void
// when_RetrieveOpenFragment_FirstFragmentThatIsOpenAndBelongsToCollectionIsReturned(
...
// .filter(ldesFragmentEntity ->
// !ldesFragmentEntity.isImmutable()).collect(Collectors.toList()));
//
// Optional<LdesFragment> view =
// ldesFragmentMongoRepository.retrieveOpenFragment(COLLECTION_NAME,
// fragmentPairList);
//
...
// @Test
// void
// when_RetrieveInitialFragment_FirstFragmentThatBelongsToCollectionIsReturned()
// {
// when(ldesFragmentEntityRepository.findAll()).thenReturn(allMutable());
// String expectedFragmentId =
// String.format("http://localhost:8080/%s?generatedAtTime=%s", COLLECTION_NAME,
// FIRST_VALUE);
//
// Optional<LdesFragment> view =
// ldesFragmentMongoRepository.retrieveInitialFragment(COLLECTION_NAME);
//
// assertTrue(view.isPresent());
// assertEquals(expectedFragmentId, view.get().getFragmentId());
// }
...
// ldesFragmentMongoRepository.retrieveAllFragments();
//
...
// String value) {
// String fragmentId =
// String.format("http://localhost:8080/%s?generatedAtTime=%s", collectionName,
// value);
