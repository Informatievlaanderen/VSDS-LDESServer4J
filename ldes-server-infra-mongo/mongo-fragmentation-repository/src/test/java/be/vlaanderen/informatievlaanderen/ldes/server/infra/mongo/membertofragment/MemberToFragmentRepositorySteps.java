...
public class MemberToFragmentRepositorySteps extends MongoFragmentationIntegrationTest {
	...
	public void iRequestTheNextMember(String viewName) {
		nextMemberToFragment = memberToFragmentRepository.getNextMemberToFragment(ViewName.fromString(viewName));
	}

	@Then("I find the member with id {string} and sequenceNr {int}")
	public void iFindTheMemberWithIdAndSequenceNr(String memberId, long sequenceNr) {
	...
	public void iDeleteTheMemberWithViewAndSequenceNr(String viewNameString, long sequenceNr) {
