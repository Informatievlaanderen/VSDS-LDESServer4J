...
class MemberTest {
    ...
    static class EqualityTestProvider implements ArgumentsProvider {
        ...
        private static final IngestedMember memberA = new IngestedMember(idA, null, null, null, true, null, null);

        @Override
        public Stream<? extends Arguments> provideArguments(ExtensionContext context) {
            return Stream.of(
                    Arguments.of(equals(), memberA, memberA),
                    Arguments.of(equals(), new IngestedMember(idA, "otherCollection", "other", LocalDateTime.now(), true, "txId", ModelFactory.createDefaultModel()),
                            memberA),
