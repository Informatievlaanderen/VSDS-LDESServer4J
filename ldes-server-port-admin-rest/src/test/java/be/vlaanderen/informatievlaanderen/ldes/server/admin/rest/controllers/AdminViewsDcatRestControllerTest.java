...
@ContextConfiguration(classes = { AppConfig.class, AdminViewsDcatRestController.class, PrefixAdderImpl.class,
        ModelConverter.class, AdminRestResponseEntityExceptionHandler.class })
class AdminViewsDcatRestControllerTest {

    private final static String COLLECTION_NAME = "collectionName";
    private final static String VIEW_NAME = "viewName";
    private final static String BASE_URL = "/admin/api/v1/eventstreams/"+COLLECTION_NAME+"/views/"+VIEW_NAME+"/dcat";
