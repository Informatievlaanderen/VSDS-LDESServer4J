...
public interface AdminViewsDcatRestController {
    ...
    void updateDcat(String collectionName, String viewName,
                    @Parameter(schema = @Schema(implementation = String.class), description = "a blank node of type dcat:DataService with only dcat:DataService properties "
                            +
                            "(e.g. dct:title) and relations (e.g. dct:license), excluding relations " +
                            "(non-configurable metadata) to dcat:Catalog and dcat:DataService", example = """
                            @prefix dct:   <http://purl.org/dc/terms/> .
                            @prefix dcat:  <http://www.w3.org/ns/dcat#> .
                            ...
                            [] a dcat:DataService ;
                              ...
                              dct:license [
                                ...
                                dct:type [
                                  ...
                                  skos:prefLabel "some license"@en
                                ]
                              ] .
                            """) Model dcat);

    void deleteDcat(String collectionName, String viewName);
