...
import be.vlaanderen.informatievlaanderen.ldes.server.maintenance.postgres.entity.CompactionRelationId;
...
public interface CompactionPageRelationEntityRepository extends JpaRepository<CompactionPageRelationEntity, CompactionRelationId> {
