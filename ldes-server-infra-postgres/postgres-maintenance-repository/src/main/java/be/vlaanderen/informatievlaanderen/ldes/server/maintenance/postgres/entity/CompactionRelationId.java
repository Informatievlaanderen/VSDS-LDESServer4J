...
@Embeddable
public class CompactionRelationId implements Serializable {
	...
	public CompactionRelationId() {
	}

	public CompactionRelationId(Long fromPageId, Long toPageId) {
	...
	public final boolean equals(Object o) {
		...
		if (!(o instanceof CompactionRelationId that)) return false;
