...
@Embeddable
public class RetentionPageMemberId implements Serializable {
	...
	public RetentionPageMemberId() {
	}

	public RetentionPageMemberId(Long memberId, Long bucketId) {
	...
	public final boolean equals(Object o) {
		...
		if (!(o instanceof RetentionPageMemberId that)) return false;
