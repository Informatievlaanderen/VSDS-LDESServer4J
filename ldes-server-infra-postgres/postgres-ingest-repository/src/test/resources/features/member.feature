Feature: MemberRepository
  ...
  Scenario: Saving a member with all attributes
    ...
    Then The member with id "mobility-hindrances/http://test-data/mobility-hindrance/1/1" can be retrieved from the database
...
#    Then The member with id "mobility-hindrances/http://test-data/mobility-hindrance/1/1" will exist
##    Delete collection
#    And The member with id "gipod/http://test-data/gipod/1/1" will not exist
#    And The member with id "gipod/http://test-data/gipod/1/2" will not exist
  ...
  Scenario: The repository can indicate if members exist or not
    When I save the members using the MemberRepository
      ...
      | http://test-data/mobility-hindrance/1/1 | mobility-hindrances | http://test-data/mobility-hindrance/1 | 2022-08-12T18:18:00 |
    Then The member with id "mobility-hindrances/http://test-data/mobility-hindrance/1/1" will exist
    And The member with id "mobility-hindrances/http://test-data/mobility-hindrance/fantasy-id" will not exist
  ...
  Scenario: Delete a member with a certain id
    ...
    Then The member with id "mobility-hindrances/http://test-data/mobility-hindrance/1/1" will exist
    When I delete the member with id "mobility-hindrances/http://test-data/mobility-hindrance/1/1"
    Then The member with id "mobility-hindrances/http://test-data/mobility-hindrance/1/2" will exist
    And The member with id "mobility-hindrances/http://test-data/mobility-hindrance/1/1" will not exist
  ...
  Scenario: Members with the same id are not bulk inserted in the MemberRepository
    ...
    Then The member with id "mobility-hindrances/http://test-data/mobility-hindrance/1/1" will not exist
