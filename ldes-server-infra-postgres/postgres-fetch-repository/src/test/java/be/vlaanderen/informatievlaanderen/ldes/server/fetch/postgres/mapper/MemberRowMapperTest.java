...
import static be.vlaanderen.informatievlaanderen.ldes.server.fetch.postgres.mapper.MemberRowMapper.MEMBER_MODEL_KEY;
import static be.vlaanderen.informatievlaanderen.ldes.server.fetch.postgres.mapper.MemberRowMapper.SUBJECT_KEY;
