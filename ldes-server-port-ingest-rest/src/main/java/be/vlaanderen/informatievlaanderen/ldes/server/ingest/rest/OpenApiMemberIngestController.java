...
public interface OpenApiMemberIngestController {
	@ApiResponse(responseCode = "200", description = "Member successfully ingested")
	@ApiResponse(responseCode = "400", description = "Linked Data Event Stream with provided collection name not found")
	@Operation(summary = "Ingest version object to collection")
	void ingestLdesMember(@RequestBody(content = {
