...
public class IngestRestConfig {
    ...
    /**
     * Building the geospatial database can take some time. If we do not do this on initialization, the first
     * ingestion will take a lot of time because of the database that needs to be constructed.
     */
    @PostConstruct
